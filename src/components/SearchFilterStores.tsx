...
// import { LoaderCircle, Mail, Phone, Printer, Search } from "lucide-react";
...
//             className="bg-gray-300 hover:bg-blue-700 hover:text-white transition-colors px-4 py-2 rounded whitespace-nowrap"
//           >
//             Filtrează rezultateleeee
//           </button>
//         </div>
...
//                 className="flex items-center border w-full rounded max-w-2xl mx-auto"
//               >
//                 <Input
//                   type="text"
...
//                   value={searchText}
//                   className="w-full h-[40px] pl-10 pr-10 bg-white"
//                 />
//               </form>
//             </div>

//             <div className="hidden lg:block absolute left-1/2 transform -translate-x-1/2 w-full max-w-2xl -z-10  ">
//               <div
//                 onSubmit={(e) => e.preventDefault()}
...
//           </div>
//           <p className="pe-5 ps-1 pt-2 lg:whitespace-nowrap md:whitespace-nowrap ">
...
const MobileView = ({
  ...
  <>
    {groupedStores.map((group, index) => (
      <div key={index} className="mb-6">
        {group.heading.split("").map((letter) => {
          const storesForLetter = group.letters.filter(
            (name) => name[0].toUpperCase() === letter
          );

          if (storesForLetter.length === 0) return null;
